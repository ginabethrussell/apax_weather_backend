...
public class UserControllerIntegrationTest
{
    ...
    public void addNewUser() throws Exception
    {
        mockMvc.perform(MockMvcRequestBuilders.post("/users/user")
            .content("{\"username\": \"Williard\", \"password\": \"weatherman\", \"primaryemail\" : \"williard@gmail.com\"}")
    ...
    {
        mockMvc.perform(MockMvcRequestBuilders.put("/users/user/9")
            .content("{\"username\": \"user\", \"password\": \"password\", \"primaryemail\" : \"user@lambda.com\"}")
            .contentType(MediaType.APPLICATION_JSON)
            .accept(MediaType.APPLICATION_JSON))
            .andDo(print())
            .andExpect(status().isOk());
